...
public class Estufa extends Applet{
    ...
    private BranchGroup crearEscenarioGrafico(){
        ...
        TextureLoader archivo = new TextureLoader("./src/Resources/Img/fondoEstufa.png",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        transformacion3d.setScale(0.2); //define el tamaño del objeto
        ...
        producto.addChild(cargarObjeto("./src/Resources/Img/Estufa.obj"));
