...
public class Nevera extends Applet {
    ...
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Nevera(args[0]),850,600);
        else
            new MainFrame(new Nevera(null),1280,720);
    }
    
    public Nevera (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        objTrans.setTranslation(new Vector3d(0.0, 0.3 ,0.0 ));
        objTrans.setScale(0.75);
        ...
        try{
           s = file.load(filename == null ? "./src/Resources/Img/Refrigerator.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("./src/Resources/Img/fondoNevera.png",this);
